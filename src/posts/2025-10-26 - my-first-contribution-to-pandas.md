...
1. **Sprints are the best entry point.** The mentors, the pre-tagged issues, the room full of people doing the same thing — it lowers the barrier enormously. Without PyCon Davao's sprint day, I probably wouldn't have taken the first step.
